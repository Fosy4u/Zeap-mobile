...
const VoucherDetailBottomSheetComponent = ({ bottomSheetModalRef, snapPoints, setShowBottomSheetModal }: IVoucherDetailBottomSheetComponent) => {
    ...
    return (
        ...
        >
            <BottomSheetView className="flex-1">
                <View className="w-full px-5 pt-7 pb-5">
                    <View>
                        <View className="h-auto w-full flex-row items-start justify-center">
