        ...
        <View className="pt-[30px] pb-5 px-[20px]">
          ...
          <View className="h-auto w-full mt-6 px-5 py-5 border border-gray-200 rounded-xl bg-[#F8F9FE]">
            <View className="flex-row items-center justify-between">
              <Text className="font-montserratSemiBold text-base text-gray-700">Otor John Stephen</Text>
              <TouchableOpacity>
            ...
            <View className="mt-4 flex-row items-center">
              ...
              <Text className="font-montserratMedium">08130000000</Text>
            </View>

            <View className="mt-4 flex-row items-center">
              <Sms size={ 16 } variant="Bold" className="mr-2 text-baseGreen" />
              <Text className="font-montserratMedium">otorjohn@gmail.com</Text>
            </View>

            <View className="mt-4 flex-row items-center">
              <Location size={ 16 } variant="Bold" className="mr-2 text-baseGreen" />
              <Text className="font-montserratMedium">No.38 Ashiek Jarma street, Jabi Abuja</Text>
            </View>
          </View>
          ...
          <Text aria-label="Name" nativeID="fullName" className="mt-5 font-montserratMedium">Name</Text>
          ...
          <Text aria-label="Email" nativeID="emailAddress" className="mt-5 font-montserratMedium">Email address</Text>
          <View className="h-auto w-full mt-1.5 px-3 py-1 border border-gray-300 rounded-xl bg-gray-100">
            <TextInput
              aria-label="Email"
          ...
          <Text aria-label="Street" nativeID="streetAddress" className="mt-5 font-montserratMedium">Street address</Text>
          <View className="h-auto w-full mt-1.5 px-3 py-1 border border-gray-300 rounded-xl bg-gray-100">
            <TextInput
              aria-label="Street"
