...
import { useSaveAutoPricePercentageMutation, useSubmitProductMutation } from "../../apis/readyMadeProduct_api";
...
const useStepSixHook = (
    ...
    const [saveAutoPricePercentage] = useSaveAutoPricePercentageMutation();
