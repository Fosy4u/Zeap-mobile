...
import { setDraftProducts, setProductMode, setProduct, setSelectedStep } from "../../slices/vendorProductState_slice";
import { useNavigation } from "@react-navigation/native";
import { NativeStackNavigationProp } from "@react-navigation/native-stack";
import RootNavigationStackModel from "../../../../../routes/model/routes_model";

const useAddBespokeShoesHook = () => {
    ...
    const handleContinueSavedDraftProduct = async () => {
        if (product?.currentStep) {
            ...
            navigation.navigate("addBespokeShoesScreen");
        }
    };
...
export default useAddBespokeShoesHook;