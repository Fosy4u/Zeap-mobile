...
const useStepTwoHook = () => {
    ...
    const handleFormatDropDownOptions = async () => {
        ...
        setMainOptions(readyMadeClothesOptions.mainEnums!);
        setStyleOptions(readyMadeClothesOptions.clothStyleEnums!);
        setGenderOptions(readyMadeClothesOptions.genderEnums!);
        setAgeGroupOptions(readyMadeClothesOptions.ageGroupEnums!);
        setAgeRangeOptions(readyMadeClothesOptions.ageRangeEnums!);
        setAgeRangeOptions(readyMadeClothesOptions.ageRangeEnums!);
        setBrandOptions(readyMadeClothesOptions.brandEnums!);
        setDesignOptions(readyMadeClothesOptions.designEnums!);
        setOccasionOptions(readyMadeClothesOptions.occasionEnums!);
        setSleeveLengthOptions(readyMadeClothesOptions.sleeveLengthEnums!);
        setFasteningOptions(readyMadeClothesOptions.fasteningEnums!);
        setFitOptions(readyMadeClothesOptions.fitEnums!);
    };
    ...
    useEffect(() => {
        if (readyMadeClothesOptions?.mainEnums) {
