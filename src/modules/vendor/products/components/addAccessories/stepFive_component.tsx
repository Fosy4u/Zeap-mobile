    ...
    return (
        <View>
                    ...
                    <View className="h-auto w-full mt-2 px-3 pt-2 rounded-lg border border-gray-200">
                        { product.variations?.map((variation: IVariation) => (
                            <View key={variation._id} className="h-auto w-full mt-4 pb-4 border-b border-b-gray-200">
                                ...
                                <View className="h-auto w-full mt-4 flex-row items-center justify-between gap-x-4">
                                    <View>
                                    ...
                                    <View className="h-auto w-auto mt-4 flex-row items-center justify-end gap-x-2">
                                        <TouchableOpacity
            ...
            { !showAddVariations && (
                ...
                >
                    <Text className="font-montserratMedium text-base text-blue-700">Add Variations</Text>
                </TouchableOpacity>
            )}
