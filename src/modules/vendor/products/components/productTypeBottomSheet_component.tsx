...
const ProductTypeBottomSheetComponent = () => {
    const { productType, clotheType, shoeType } = useSelector((state: RootState) => state.vendorProductState);
            ...
            >
                ...
                <View className="h-[110px] w-full pt-4 px-5 rounded-t-xl rounded-b-3xl bg-baseGreen">
                    <View className="h-auto w-full flex-row items-center justify-between ">
                        ...
                        <Text className="font-montserratMedium text-xl text-white">{ productType } Type</Text>
                ...
                <View className="h-[calc(78%)] w-full px-5 py-7 flex-col justify-between">
                    <View className="">
                        <Text className="font-montserratMedium text-base text-gray-700">Select { productType.toLowerCase() } type to add</Text>

                        <View className="h-auto w-full mt-5 flex-row">
                            <TouchableOpacity
                                onPress={ () => (productType === "Clothes") ? dispatch(setClotheType("Bespoke")) : dispatch(setShoeType("Bespoke")) }
                                className={`h-auto w-full px-5 py-5 flex-1 rounded-xl border ${
                                    (productType === "Clothes") ? (clotheType === "Bespoke" ? "border-baseGreen" : "border-gray-100") : (shoeType === "Bespoke" ? "border-baseGreen" : "border-gray-100")
                                } bg-gray-50`}
                            >
                            ...
                            <TouchableOpacity
                                onPress={ () => (productType === "Clothes") ? dispatch(setClotheType("Readymade")) : dispatch(setShoeType("Readymade")) }
                                className={`h-auto w-full px-5 py-5 flex-1 rounded-xl border ${
                                    (productType === "Clothes") ? (clotheType === "Readymade" ? "border-baseGreen" : "border-gray-100") : (shoeType === "Readymade" ? "border-baseGreen" : "border-gray-100")
                                } bg-gray-50`}
                            >
                                <View className="w-[50px] h-[50px] flex-row items-center justify-center rounded-xl bg-gray-100">
                                    <Image
                    ...
                    <TouchableOpacity
                        onPress={ () => {
                            ...
                            (productType === "Clothes") ? (
                                ...
                                shoeType === "Bespoke" ? navigation.navigate("addBespokeShoesScreen") : navigation.navigate("addReadyMadeShoesScreen")
                            );
                        } }
...
export default ProductTypeBottomSheetComponent
