...
import { ArrowDown2, ArrowRight, Camera } from "iconsax-react-native";
    ...
    <SafeAreaView className="flex-1 px-5 pt-5 items-center">
      ...
      <View className="h-full w-full pb-3">
        ...
        >
          ...
          <View className="h-[48px] w-auto mx-auto mt-2 relative">
            ...
            <View className="h-0 w-0 absolute top-[30px] left-[50%] translate-x-[-125px] border-l-[10px] border-l-transparent border-r-[10px] border-r-transparent border-t-[18px] border-t-gold" />
          </View>
          ...
          <View className="h-auto w-full">
            ...
            <Text className="mt-5">State/Region</Text>
            <View className="h-auto w-full mt-1.5 py-0 flex-row items-center justify-between border border-gray-300 rounded-xl bg-gray-100">
              <SelectList
                setSelected={ setSelected }
                data={ data }
