  ...
  return (
    <SafeAreaView className="flex-1">
        ...
        <Image
          source={
            progress === 1
              ...
              : progress === 2
              ? require('../../../../assets/images/onboarding_two_image.png')
              : progress === 3
              ? require('../../../../assets/images/onboarding_three_image.png')
      ...
      <View className="flex-[0.55] px-7 pt-4 items-center bg-white">
        <Text className="font-bold text-2xl text-baseGreen">
          {progress === 1
        ...
        <View className="h-auto w-full mt-5 flex-1 flex-row justify-center">
          ...
          {progress !== 4 && (
            <TouchableOpacity
              ...
              <Text className="font-medium text-lg text-baseGreen mr-2">
                Skip
              </Text>
